...
public class FileSystemTest {
    ...
    /**
     * Functional Testing. This test case will test if an error is thrown if the
     * program tries to read a deleted file
     */
    @Test
    ...
    /**
     * Functional Testing and Negative Testing. This test checks if exception is
     * thrown if an unreadable file is read
     */
    @Test
    ...
    /**
     * Functional Testing and Negative Testing. This test case will test if
     * SQLException is thrown a file read is not a valid file.
     */
    @Test
    ...
    /**
     * Functional Testing and Positive Testing. This test will test that the program
     * will be able to save a blank address book.
     */
    @Test
     ...
     * program will read a blank file.
     */
    @Test
    public void readBlankAddressBook() {
        // JUNIT says to not write tests with dependencies and that tests should be able
        // to execute
        // in any order. Thus, this test will only succeed if the blank file can be
        // saved AND read
        assertDoesNotThrow(() -> FileSystem.saveFile(addressBook, file));
    ...
    /**
     * Functional Testing and Positive Testing. This test case will test the program
     * saving a valid address book.
     */
    @Test
    @Timeout(value = 120000) // 120 seconds, two minutes max time to access database
    ...
    /**
     * Function Testing and Positive Testing. This test case will test the program
     * will open a valid file
     */
    @Test
    @Timeout(value = 120000) // 120 seconds, two minutes max time to access database
    ...
    /**
     * Functional Testing and Positive Testing. This test case will test that
     * program will be able to successfully overwrite a saved file.
     */
    @Test
